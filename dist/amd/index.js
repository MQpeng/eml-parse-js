define("charset", ["require", "exports", "text-encoding"], function (require, exports, text_encoding_1) {
    "use strict";
...
define("utils", ["require", "exports", "charset"], function (require, exports, charset_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
...
define("index", ["require", "exports", "js-base64", "charset", "utils"], function (require, exports, js_base64_1, charset_2, utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Base64 = js_base64_1.Base64;
    exports.convert = charset_2.convert;
    exports.decode = charset_2.decode;
    exports.encode = charset_2.encode;
    ...
    function decodeJoint(str) {
        ...
        if (match) {
            ...
            if (type === 'B') {
                //Base64
                if (charset === 'utf8') {
                    return charset_2.decode(charset_2.encode(js_base64_1.Base64.fromBase64(value.replace(/\r?\n/g, ''))), 'utf8');
                }
                else {
                    return charset_2.decode(js_base64_1.Base64.toUint8Array(value.replace(/\r?\n/g, '')), charset);
                }
            }
            else if (type === 'Q') {
                //Quoted printable
            ...
            if (data.attachments) {
                for (var i = 0; i < data.attachments.length; i++) {
                    ...
                    if (typeof attachment.data === 'string') {
                        ...
                        var content = charset_2.decode(attachment.data);
                        eml += utils_1.wrap(content, 72) + EOL;
                    }
                    eml += EOL;
                }
        ...
        function _append(headers, content, result) {
            ...
            if (encoding === 'base64') {
                if (contentType && contentType.indexOf('gbk') >= 0) {
                    ...
                    content = charset_2.encode(utils_1.GB2312UTF8.GB2312ToUTF8(content.replace(/\r?\n/g, '')));
                }
                else {
                    // string to Uint8Array by TextEncoder
                    content = charset_2.encode(content.replace(/\r?\n/g, ''));
                }
            }
                ...
                content = charset_2.decode(content, charset);
            }
            if (!result.html && contentType && contentType.indexOf('text/html') >= 0) {
                ...
                attachment.data64 = charset_2.decode(content, charset);
