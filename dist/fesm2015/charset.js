 ...
 */
export function decode(buf, fromCharset) {
    if (fromCharset === void 0) { fromCharset = 'utf-8'; }
    var charsets = [
 ...
 * @return {Uint8Array} UTF-8 encoded typed array
 */
export var convert = function (data, fromCharset) {
